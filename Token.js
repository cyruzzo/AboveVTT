...
class Token {
	...
	build_elev() {
		...
		if (parseFloat(this.options.elev) > 0) {
			...
			<text x='6px' y='8px' style="font-weight: bold;font-size: 5px;stroke: #000;stroke-width: 6%;paint-order: stroke;stroke-linejoin: round;fill: #fff;text-anchor: middle;">${this.options.elev}</text>
