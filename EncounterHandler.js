		...
		$("#resizeDragMon").draggable({
			...
			start: function () {
				$("#resizeDragMon").each(function (index, element) {
					var d = $('<div class="iframeResizeCover" style="z-index:99;position:absolute;width:100%;top:0px;left:0px;bottom:0;right:0;height:100%;"></div>');
					$(element).append(d);
				});
				$("#sheet").each(function (index, element) {
					var d = $('<div class="iframeResizeCover" style="z-index:99;position:absolute;width:100%;top:0px;left:0px;bottom:0;right:0;height:height:100%;></div>');
					$(element).append(d);
				});
