...
function setup_aoe_button() {
    ...
    aoe_menu.append("<div style='font-weight:900; background: #444; color: white'>Size</div>");
    aoe_menu.append("<div><input tabindex='2' id='aoe_feet' value='20' style='width:75px;margin:0px;text-align:center' maxlength='10'></div>");

    aoe_menu.append("<div style='font-weight:900; background: #444; color: white'>Color</div>");
    ...
    aoe_menu.append("<div style='font-weight:900; background: #444; color: white'>Shape</div>");
