...
function setup_aoe_button() {
    ...
    aoe_menu.append("<div style='font-weight:900; background: #888; color: white'>Color</div>");
    ...
    aoe_menu.append("<div style='font-weight:900; background: #888; color: white'>Shape</div>");
