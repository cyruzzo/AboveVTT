...
function addGamelogPopoutButton(){
	...
	let windowTarget = `https://dndbeyond.com/campaigns/${window.find_game_id()}?id=${window.PLAYER_ID}&popoutgamelog=true`
