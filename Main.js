...
function init_buttons() {
	...
	fog_menu.append("<div style='font-weight: 900; background: #888; color: white'>Reveal</div>");
	...
	fog_menu.append("<div style='font-weight: 900; background: #888; color: white'>Hide</div>");
	...
	draw_menu.append("<div style='font-weight:900; background: #888; color: white'>Tool</div>");
	...
	draw_menu.append("<div style='font-weight:900; background: #888; color: white'>Fill Type</div>");
	...
	draw_menu.append("<div style='font-weight:900; background: #888; color: white'>Line Width</div>");
	...
	if (window.DM){
		...
		draw_menu.css("left",draw_button.position().left - 1);
