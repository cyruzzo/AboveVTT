...
function reset_zoom () {
	...
	// }
	// if (zoom > 0.1 && zoom < 0.15){
	// 	console.log("map is a probably square")
	// }
	// else if (zoom > 0.4 && zoom < 0.5){
	// 	console.log("map is a probably tall")
	// }
	// else if (zoom > 0.6 && zoom < 0.65){
	// 	console.log("map is a probably wide")
	// }
	// console.log("setting zoom to ", zoom)
	vttHeight = $("#VTTWRAPPER")[0].offsetHeight
	sceneMapHeight = $("#scene_map")[0].height
	console.log(sceneMapHeight > vttHeight, sceneMapHeight, vttHeight)
	while(sceneMapHeight > vttHeight)
		console.log("zooming out")
		change_zoom(window.ZOOM - 0.1);
