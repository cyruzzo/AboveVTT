...
function reset_zoom () {
    ...
    relativeMapHeight = window.ZOOM * sceneHeight
	if (relativeMapHeight < window.height){
		console.log(`zooming out because of height. relative height ${relativeMapHeight},window height ${window.height}`)
		decrease_zoom()
	}
	else{ 
		console.log(`zooming in because of height. relative height ${relativeMapHeight},window height ${window.height}`)
		increase_zoom()
	}
	window.height
    console.log(`mapsize: ${sceneHeight}, zoom: ${window.ZOOM}`)
