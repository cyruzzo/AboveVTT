...
function reset_zoom () {
	...
	if (heightDiff > widthDiff){
		console.log("using height as to fit")
		zoom=heightDiff
	}
	else{
		console.log("using height as to fit")
	...
	if (heightDiff > 0.1 && heightDiff < 0.15){
		console.log("map is a probably square")
	}
	if (heightDiff > 0.4 && heightDiff < 0.5){
		console.log("map is a probably wide")
	}
	if (heightDiff > 0.55 && heightDiff < 0.6){
		console.log("map is a probably tall")
	}
	console.group("zooming in or out by ", zoom)
	change_zoom(zoom);
